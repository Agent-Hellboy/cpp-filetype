#ifndef FILETYPE_TYPES_DOCUMENT_HPP
#define FILETYPE_TYPES_DOCUMENT_HPP
...
inline const std::array<uint8_t, 8> DOC_MAGIC = {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1};
...
inline const std::array<uint8_t, 8> XLS_MAGIC = {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1};
...
// Magic: D0 CF 11 E0 A1 B1 1A E1 (same as DOC)
inline const std::array<uint8_t, 8> PPT_MAGIC = {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1};
...
inline const Type TYPE_ODS{"application/vnd.oasis.opendocument.spreadsheet", "ods"};

// OpenDocument Presentation format
// Magic: 50 4B 03 04 (PK..)
// Note: This is a ZIP file signature; additional verification is needed.
inline const std::array<uint8_t, 4> ODP_MAGIC = {0x50, 0x4B, 0x03, 0x04};
inline const Type TYPE_ODP{"application/vnd.oasis.opendocument.presentation", "odp"};
